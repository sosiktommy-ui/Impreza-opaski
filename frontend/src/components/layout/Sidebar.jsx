...
const MAIN_ITEMS = [
  ...
  {
    to: '/transfers', label: 'Переводы', roles: ROLES,
  ...
  {
    to: '/expenses', label: 'Списания', roles: ROLES,
...
const MANAGE_ITEMS = [
  {
    to: '/users', label: 'Пользователи', roles: ['ADMIN', 'OFFICE', 'COUNTRY'],
  ...
  {
    to: '/geodata', label: 'География', roles: ['ADMIN', 'OFFICE'],
